...
template class DeviceVector<util::array<float, 56>>;
template class DeviceVector<util::array<float, 98>>;
...
template class DeviceVector<util::array<double, 56>>;
template class DeviceVector<util::array<double, 98>>;
